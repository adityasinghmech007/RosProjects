...
#include "my_robot_interfaces/msg/detail/battery_status__rosidl_typesupport_fastrtps_c.h"
...
using _BatteryStatus__ros_msg_type = my_robot_interfaces__msg__BatteryStatus;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
bool cdr_serialize_my_robot_interfaces__msg__BatteryStatus(
  const my_robot_interfaces__msg__BatteryStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: batterylevel
  {
    cdr << ros_message->batterylevel;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
bool cdr_deserialize_my_robot_interfaces__msg__BatteryStatus(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces__msg__BatteryStatus * ros_message)
{
  // Field name: batterylevel
  {
    cdr >> ros_message->batterylevel;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t get_serialized_size_my_robot_interfaces__msg__BatteryStatus(
  ...
  size_t current_alignment)
{
  ...
  // Field name: batterylevel
  {
    size_t item_size = sizeof(ros_message->batterylevel);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_my_robot_interfaces__msg__BatteryStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces__msg__BatteryStatus;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
bool cdr_serialize_key_my_robot_interfaces__msg__BatteryStatus(
  const my_robot_interfaces__msg__BatteryStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: batterylevel
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t get_serialized_size_key_my_robot_interfaces__msg__BatteryStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BatteryStatus__ros_msg_type * ros_message = static_cast<const _BatteryStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_key_my_robot_interfaces__msg__BatteryStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_robot_interfaces__msg__BatteryStatus * ros_message = static_cast<const my_robot_interfaces__msg__BatteryStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_robot_interfaces__msg__BatteryStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_robot_interfaces__msg__BatteryStatus * ros_message = static_cast<my_robot_interfaces__msg__BatteryStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_robot_interfaces__msg__BatteryStatus(cdr, ros_message);
}

static uint32_t _BatteryStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__msg__BatteryStatus(
...
static size_t _BatteryStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__msg__BatteryStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, msg, BatteryStatus)() {
