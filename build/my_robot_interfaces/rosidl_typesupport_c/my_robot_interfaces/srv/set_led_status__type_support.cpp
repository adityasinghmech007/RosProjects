...
static const _SetLedStatus_Event_type_support_symbol_names_t _SetLedStatus_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, srv, SetLedStatus_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interfaces, srv, SetLedStatus_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_interfaces, srv, SetLedStatus_Event)() {
  return &::my_robot_interfaces::srv::rosidl_typesupport_c::SetLedStatus_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetLedStatus_service_type_support_handle = {
  ...
  &SetLedStatus_Request_message_type_support_handle,
  &SetLedStatus_Response_message_type_support_handle,
  &SetLedStatus_Event_message_type_support_handle,
