...
bool my_robot_interfaces__msg__pred_turtle_location__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces.msg._pred_turtle_location.PredTurtleLocation", full_classname_dest, 64) == 0);
  }
  my_robot_interfaces__msg__PredTurtleLocation * ros_message = _ros_message;
  {  // x_coordinate
...
{
  /* NOTE(esteve): Call constructor of PredTurtleLocation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.msg._pred_turtle_location");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PredTurtleLocation");
