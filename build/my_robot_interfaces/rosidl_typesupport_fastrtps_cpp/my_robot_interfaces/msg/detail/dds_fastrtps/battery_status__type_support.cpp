...
#include "my_robot_interfaces/msg/detail/battery_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::msg::BatteryStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::msg::BatteryStatus & ros_message)
{
  // Member: batterylevel
  cdr >> ros_message.batterylevel;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::msg::BatteryStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::msg::BatteryStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::msg::BatteryStatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<my_robot_interfaces::msg::BatteryStatus>()
{
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_BatteryStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, msg, BatteryStatus)() {
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_BatteryStatus__handle;
}
