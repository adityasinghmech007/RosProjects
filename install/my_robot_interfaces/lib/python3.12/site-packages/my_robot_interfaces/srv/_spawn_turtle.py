...
class Metaclass_SpawnTurtle_Event(type):
    """Metaclass of message 'SpawnTurtle_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__spawn_turtle__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__spawn_turtle__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__spawn_turtle__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__spawn_turtle__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__spawn_turtle__event
...
class SpawnTurtle_Event(metaclass=Metaclass_SpawnTurtle_Event):
    """Message class 'SpawnTurtle_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<my_robot_interfaces/SpawnTurtle_Request, 1>',
        'response': 'sequence<my_robot_interfaces/SpawnTurtle_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'srv'], 'SpawnTurtle_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'srv'], 'SpawnTurtle_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from my_robot_interfaces.srv import SpawnTurtle_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SpawnTurtle_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SpawnTurtle_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from my_robot_interfaces.srv import SpawnTurtle_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SpawnTurtle_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SpawnTurtle_Response'"
...
class Metaclass_SpawnTurtle(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _spawn_turtle.Metaclass_SpawnTurtle_Event._TYPE_SUPPORT is None:
                _spawn_turtle.Metaclass_SpawnTurtle_Event.__import_type_support__()
...
class SpawnTurtle(metaclass=Metaclass_SpawnTurtle):
    ...
    from my_robot_interfaces.srv._spawn_turtle import SpawnTurtle_Event as Event
