...
bool my_robot_interfaces__srv__prey_turtle_location__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces.srv._prey_turtle_location.PreyTurtleLocation_Request", full_classname_dest, 72) == 0);
  }
  my_robot_interfaces__srv__PreyTurtleLocation_Request * ros_message = _ros_message;
  {  // x_coordinate
...
{
  /* NOTE(esteve): Call constructor of PreyTurtleLocation_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.srv._prey_turtle_location");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PreyTurtleLocation_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool my_robot_interfaces__srv__prey_turtle_location__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces.srv._prey_turtle_location.PreyTurtleLocation_Response", full_classname_dest, 73) == 0);
  }
  my_robot_interfaces__srv__PreyTurtleLocation_Response * ros_message = _ros_message;
  {  // status_message
...
{
  /* NOTE(esteve): Call constructor of PreyTurtleLocation_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.srv._prey_turtle_location");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PreyTurtleLocation_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
